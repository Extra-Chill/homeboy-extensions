...
# Bootstrap Homeboy core's shared command capture helper for direct extension invocation.
...
homeboy_source_core_runtime_helper HOMEBOY_RUNTIME_COMMAND_CAPTURE command-capture.sh
