...
# Bootstrap Homeboy core's shared runner prelude for direct extension invocation.
...
homeboy_source_core_runtime_helper HOMEBOY_RUNTIME_RUNNER_PRELUDE runner-prelude.sh
