...
assert.equal(result.wp_codebox_execution_request.ability, 'wp-codebox/run-fuzz-suite');
assert.equal(result.wp_codebox_execution_request.input.schema, 'wp-codebox/fuzz-suite/v1');
assert.equal(result.fuzz_runtime_task_request, undefined);
assert.equal(result.fuzz_runtime_task_result, undefined);
