...
│  └─ Extension runtime     (test-runner.sh)                       │
│                                                               │
└─────────────────────────────────────────────────────────────────┘
```
...
A: Yes. Configure it via extension settings: `homeboy config set extensions.wordpress.database_type mysql`

**Q: Do I need a wp-config.php in my project?**
A: No. The extension generates a temporary wp-config.php during test execution.
