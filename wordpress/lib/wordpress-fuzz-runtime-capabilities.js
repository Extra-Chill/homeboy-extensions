...
const WORDPRESS_FUZZ_RUNTIME_CAPABILITY_ALIASES = new Map([
	...
	['disposable-sandbox', 'disposable-runtime'],
	['disposable_sandbox', 'disposable-runtime'],
	['sandbox-disposable', 'disposable-runtime'],
	['sandbox_disposable', 'disposable-runtime'],
	['disposable-boundary', 'disposable-sandbox-boundary'],
	['disposable_boundary', 'disposable-sandbox-boundary'],
	['sandbox-boundary', 'disposable-sandbox-boundary'],
	['sandbox_boundary', 'disposable-sandbox-boundary'],
	['destructive_permission', 'destructive-permission'],
	['destructive-mutation-permission', 'destructive-permission'],
	['destructive_mutation_permission', 'destructive-permission'],
	['mutation-isolation', 'mutation-isolation-artifact'],
	['mutation_isolation', 'mutation-isolation-artifact'],
	['mutation-boundary', 'mutation-isolation-artifact'],
	['mutation_boundary', 'mutation-isolation-artifact'],
	['delete-boundary', 'delete-boundary-artifact'],
	['delete_boundary', 'delete-boundary-artifact'],
	['sandbox-isolation', 'sandbox-isolation-proof'],
	['sandbox_isolation', 'sandbox-isolation-proof'],
	['sandbox-proof', 'sandbox-isolation-proof'],
	['sandbox_proof', 'sandbox-isolation-proof'],
	...
	['external-side-effect', 'external-side-effect-guardrail'],
	['external_side_effect', 'external-side-effect-guardrail'],
	['external-side-effect-guardrail', 'external-side-effect-guardrail'],
	['external_side_effect_guardrail', 'external-side-effect-guardrail'],
...
const WORDPRESS_FUZZ_RUNTIME_CAPABILITY_REQUIREMENTS = Object.freeze({
	mutating_crud: Object.freeze(['crud', 'disposable-runtime', 'disposable-sandbox-boundary', 'destructive-permission', 'mutation-isolation-artifact', 'sandbox-isolation-proof']),
	mutating_rest: Object.freeze(['rest', 'disposable-runtime', 'disposable-sandbox-boundary', 'destructive-permission', 'mutation-isolation-artifact', 'sandbox-isolation-proof']),
	rest_crud_mutation: Object.freeze(['crud', 'rest', 'disposable-runtime', 'disposable-sandbox-boundary', 'destructive-permission', 'mutation-isolation-artifact', 'sandbox-isolation-proof']),
	admin_mutation: Object.freeze(['admin', 'disposable-runtime', 'disposable-sandbox-boundary', 'destructive-permission', 'sandbox-isolation-proof']),
	db_mutation: Object.freeze(['database', 'disposable-runtime', 'disposable-sandbox-boundary', 'destructive-permission', 'mutation-isolation-artifact', 'sandbox-isolation-proof']),
});
