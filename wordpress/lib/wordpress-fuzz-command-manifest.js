...
const CASE_INTENT_REQUIREMENTS = Object.freeze({
	...
	'plan-admin-page-mutation': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['admin', ...DISPOSABLE_DESTRUCTIVE_CAPABILITIES], runner_modes: ['runtime-backed'] }),
	...
	'mutate-database-table': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['database', ...DISPOSABLE_DESTRUCTIVE_CAPABILITIES] }),
	'mutate-database-query': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['database', ...DISPOSABLE_DESTRUCTIVE_CAPABILITIES] }),
	...
	'create-post': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['crud', ...DISPOSABLE_DESTRUCTIVE_CAPABILITIES] }),
	'update-post': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['crud', ...DISPOSABLE_DESTRUCTIVE_CAPABILITIES] }),
	'delete-post': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['crud', ...DISPOSABLE_DESTRUCTIVE_CAPABILITIES] }),
	...
	'create-user': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['crud', ...DISPOSABLE_DESTRUCTIVE_CAPABILITIES] }),
	'update-user': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['crud', ...DISPOSABLE_DESTRUCTIVE_CAPABILITIES] }),
	'delete-user': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['crud', ...DISPOSABLE_DESTRUCTIVE_CAPABILITIES] }),
	'read-option': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['crud'] }),
	'create-option': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['crud', ...DISPOSABLE_DESTRUCTIVE_CAPABILITIES] }),
	'update-option': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['crud', ...DISPOSABLE_DESTRUCTIVE_CAPABILITIES] }),
	'delete-option': Object.freeze({ commands: ['run-wordpress-workload'], abilities: ['wp-codebox/run-wordpress-workload'], capabilities: ['crud', ...DISPOSABLE_DESTRUCTIVE_CAPABILITIES] }),
});
