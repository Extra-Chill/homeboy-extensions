...
### Fixed
- fail a suite whose suite-owned changed-file scope executed zero tests

## [3.49.1] - 2026-09-23

### Fixed
- report locked Composer versions in deps status
...
### Fixed
- expose canonical standalone dependency identities
...
### Fixed
- rank runtime service provisioning failures above the ledger
...
### Fixed
- default the Lint capability to the shipped PHPCS ruleset
...
### Fixed
- report structured counts for declared JavaScript test runs
...
### Fixed
- allow bounded setup completion
...
### Fixed
- forward benchmark scenario selection
...
### Fixed
- bind candidate SHA before build
...
### Changed
- consolidate PHPUnit selection smokes

## [3.38.9] - 2026-08-25

### Changed
- delegate source cache installs
...
### Changed
- isolate WP Codebox resolver smokes

## [3.38.6] - 2026-08-24

### Fixed
- run declared full-suite PHP tests
...
### Fixed
- order Git URL delimiter correctly
...
### Fixed
- expose host smoke runtime roots
...
### Fixed
- replay assigned test shard manifests
...
### Fixed
- publish referenced PHPUnit output

## [3.34.49] - 2026-08-14

### Fixed
- preserve PHPUnit failure output
...
### Fixed
- execute every selected changed-scope test
...
### Fixed
- discover JavaScript tests in nested packages
...
### Fixed
- resolve runtime helpers from current layout

## [3.34.25] - 2026-08-03

### Fixed
- stabilize WordPress lint fingerprints

## [3.34.24] - 2026-08-03

### Fixed
- honor project PHPUnit bootstraps
...
### Fixed
- preserve PHPUnit parser failure evidence
...
### Fixed
- accept untyped recovery zips

## [3.34.13] - 2026-07-28

### Fixed
- publish recovery artifacts
...
### Fixed
- route composed Node tests

## [3.34.7] - 2026-07-27

### Fixed
- preserve authoritative PHPUnit failures
- normalize PHPUnit sidecar status
...
### Fixed
- trust resolved PHPUnit dependencies
...
### Fixed
- exclude the installed dependency tree from lint discovery
...
### Fixed
- restore explicit PHPUnit runtime preparation

## [3.31.9] - 2026-07-24

### Fixed
- preserve structured PHPUnit failure evidence

## [3.31.8] - 2026-07-24

### Fixed
- ignore nested WordPress build bundles
...
### Fixed
- activate PHPUnit validation dependencies

## [3.31.5] - 2026-07-23

### Fixed
- execute local WP Codebox cache refresh directly

## [3.31.4] - 2026-07-23

### Fixed
- forward PHPUnit runtime PHP version
...
### Fixed
- isolate multisite browser scenarios
...
### Fixed
- skip absent PHPUnit suites (by Chris Huber)
...
### Fixed
- restore extension readiness check
...
### Changed
- Make WordPress artifact helpers self-contained
...
### Fixed
- Fix Homeboy runtime helper path
...
### Changed
- Add WordPress fuzz manifest contract helper
...
### Fixed
- fix(wp-codebox): persist refreshed Codex auth
...
### Fixed
- preserve codebox typed bundle outputs
...
### Changed
- share wp-codebox recipe execution helper

## [3.2.3] - 2026-06-17

### Fixed
- preflight defaulted codex provider plugins
...
### Fixed
- keep bench env out of phpunit recipes
...
### Fixed
- make sidecar writer available to standalone lint runs
...
### Fixed
- advertise wordpress manifest capabilities
...
### Changed
- remove brittle Codebox profile smoke

## [2.121.46] - 2026-06-15

### Fixed
- refresh wp codebox composer autoload
...
### Fixed
- prepare wp codebox trace dependencies
...
### Fixed
- harden WordPress host smoke diagnostics

## [2.121.38] - 2026-06-15

### Fixed
- pass component contracts to Codebox

## [2.121.37] - 2026-06-15

### Fixed
- prepare composer autoload for wp codebox tests
...
### Fixed
- prepare codebox runtime component plugins
...
### Fixed
- materialize WordPress bench dependency packages
...
### Fixed
- preserve tracked file paths in host lifecycle
...
### Fixed
- fix datamachine agent publication hygiene
...
### Fixed
- fix datamachine agent host publication base
...
### Changed
- Seed local runner workspaces for agent CI

## [2.119.10] - 2026-06-11

### Fixed
- run selected WP bench rig overlays
...
### Fixed
- filter wordpress bench rig workloads
...
### Fixed
- run verification through wp codebox workspace
...
### Fixed
- parse prefixed WP Codebox workload output

## [2.119.0] - 2026-06-11

### Added
- add WooCommerce bench fixture profiles

## [2.118.1] - 2026-06-11

### Fixed
- reject unpublished Data Machine agent writes
...
### Fixed
- persist Codebox transcript artifacts
...
### Fixed
- include runtime metadata in Codebox tool policy
...
### Changed
- Support external Codebox recipe evidence

## [2.115.41] - 2026-06-05

### Fixed
- resolve canonical bundle outputs
...
### Fixed
- fix wp-codebox phpunit runner plumbing
...
### Fixed
- keep generic codebox tasks out of bundle mode
...
### Fixed
- stabilize WordPress PHPStan release preflight
...
### Fixed
- support WordPress bench prepare steps
...
### Fixed
- scan WordPress PHPStan override symbols
...
### Fixed
- map Codebox completed status for Homeboy
...
### Fixed
- use WP Codebox agent task contract
...
### Fixed
- prepare Composer bench dependencies

## [2.115.2] - 2026-06-04

### Fixed
- pass datamachine bundle config into Codebox
...
### Fixed
- preserve codebox config artifacts on timeout

## [2.114.5] - 2026-06-03

### Fixed
- stabilize wordpress build syntax checks
...
### Fixed
- configure WordPress bench PHP memory
...
### Fixed
- build WordPress bench recipes through WP Codebox
...
### Fixed
- expose WordPress quality helper paths

## [2.113.7] - 2026-06-02

### Fixed
- surface codebox preflight diagnostics

## [2.113.6] - 2026-06-02

### Fixed
- promote block quality probes
...
### Fixed
- update Codebox agent task dependency
...
### Fixed
- consume Lab mappings and list Codebox bench workloads
